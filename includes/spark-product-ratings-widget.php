...
class Spark_Product_Rating_Widget extends WP_Widget {
	/**
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Product rating', 'spark-product-ratings' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display products by rating', 'spark-product-ratings' );
